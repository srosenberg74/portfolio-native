    ...
    <View style={styles.layout}>
      <View style={styles.content}>
        <Text style={styles.heading}>Education</Text>
          ...
          <Text style={styles.body}>I am 3 units away from completing my A.S. Degree in Web Design.
        ...
        <Text
          style={styles.subheadingCareer}
        >
        Bachelor's Degree in English | UC Santa Barbara | 1993-1998{" "}
          </Text>
          <Text style={styles.body}>I have a Bachelor of Arts Degree in English from the University
